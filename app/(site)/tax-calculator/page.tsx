...
export default function TaxCalculatorPage() {
  /**
   * Access state
   * Later this can come from DB after email capture
   */
  ...
  <header className="mx-auto max-w-2xl text-center space-y-4">
    ...
    <p className="text-base text-muted-foreground">
      Estimate your federal taxes, self-employment tax, and quarterly
      payments using current IRS rules — no login required.
    </p>
  </header>
  ...
  {/* Trust / Footer */}
  <footer className="mx-auto mt-10 max-w-3xl border-t pt-6 text-center text-xs text-muted-foreground space-y-2">
    <p>
      Estimates are for planning purposes only and are not a filed tax return.
    </p>
    <p>
      Calculations based on 2025 IRS guidance. Results may vary based on
