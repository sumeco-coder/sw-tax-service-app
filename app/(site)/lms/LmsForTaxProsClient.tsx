  ...
  return (
    <div className="border border-blue-100 rounded-2xl bg-white/80">
      ...
      >
        ...
        <span className="ml-4 text-xl text-[#bb4823]">{open ? "−" : "+"}</span>
      </button>
      {open && (
        <div className="px-4 sm:px-5 pb-4 text-sm text-gray-700">{answer}</div>
      )}
    </div>
  );
}
...
export function LmsForTaxProsClient() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-blue-50">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-10">
        <div className="flex flex-col lg:flex-row items-center gap-10">
          ...
          <div className="flex-1">
            <p className="inline-flex items-center text-xs font-semibold tracking-wide uppercase text-primary bg-secondary border border-border rounded-full px-3 py-1 mb-4">
            ...
            <div className="mt-6 flex flex-wrap gap-4 items-center">
              <a
                href="#waitlist"
                className="inline-flex items-center justify-center rounded-full px-6 py-3 text-sm font-semibold text-white shadow-md hover:shadow-lg transition-shadow focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          ...
          <div className="flex-1 w-full">
            <div className="rounded-2xl bg-card/90 backdrop-blur-md shadow-lg border border-border px-6 py-6 sm:px-8 sm:py-8">
              ...
              <h2 className="text-xl font-bold text-foreground mb-4">
                ...
                <span className="text-accent"> Not Random PDFs.</span>
              </h2>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                <li className="flex gap-3">
                  ...
                  <span>
                    ...
                    <strong className="text-foreground">
                      1040 individual returns, EITC, CTC, HOH,
                    </strong>{" "}
                    and more.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    Upload your own{" "}
                    <strong className="text-foreground">
                      SOPs, scripts, and office policies
                    </strong>{" "}
                    so everything lives in one clean hub.
                  </span>
                </li>
      ...
      {/* Features Section */}
      <section className="bg-card/90 border-y border-border">
        <div className="max-w-6xl mx-auto px-6 py-12 sm:py-16">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-border bg-secondary/60 p-5">
              ...
              <p className="text-sm text-muted-foreground">
                Turn &quot;Can you train me?&quot; into &quot;Here&apos;s your
                login.&quot; Track who is ready for live returns and who needs
                more practice.
              </p>
            </div>
          </div>
      ...
      {/* FAQ Section */}
      <section className="bg-card/90 border-t border-border">
      ...
      <section
        id="waitlist"
        className="text-primary-foreground py-12 sm:py-16"
        style={{ background: "var(--brand-gradient)" }}
      >
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid gap-8 md:grid-cols-2 items-start">
            <div>
              <p className="text-xs font-semibold tracking-wide uppercase text-primary-foreground/80 mb-2">
            ...
            <div className="bg-card text-card-foreground rounded-2xl p-5 shadow-lg border border-border">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full inline-flex justify-center items-center rounded-full px-4 py-2.5 text-sm font-semibold text-white
                         shadow-md hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed transition-all
