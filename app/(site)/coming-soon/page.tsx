...
export default function ComingSoonPage() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      {/* Top soft glow (uses your brand tokens) */}
      <div className="relative overflow-hidden">
        ...
        <section className="mx-auto max-w-3xl px-6 pb-14 pt-20 text-center sm:pt-24">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm text-muted-foreground sm:text-base">
            This page isn’t live yet — but it will be. Join the waitlist and we’ll
          ...
          <footer className="mt-14 border-t border-border pt-8 text-center text-xs text-muted-foreground">
            ...
            •{" "}
            <a className="underline hover:text-foreground" href="https://www.swtaxservice.com" target="_blank" rel="noreferrer">
              swtaxservice.com
            </a>
          </footer>
        </section>
