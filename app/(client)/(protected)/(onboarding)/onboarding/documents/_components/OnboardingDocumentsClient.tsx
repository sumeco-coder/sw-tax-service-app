// app/(protected)/(client)/onboarding/documents/_components/OnboardingDocumentsClient.tsx
"use client";
      ...
      <div className="mx-auto max-w-2xl">
        <div className="rounded-2xl bg-card p-6 text-card-foreground shadow-sm ring-1 ring-border">
          ...
          <form
            ...
            className="space-y-4"
          >
            {/* ✅ remove hidden cognitoSub/email inputs — server action should trust auth.sub */}
