    ...
    <main className="min-h-screen bg-slate-50">
      <div className="mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="mt-4 rounded-2xl border bg-white p-8 shadow-sm">
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">Deductions & Credits</h1>
          <p className="mt-2 text-slate-600">
            Credits reduce your tax bill. Deductions reduce taxable income. Here are starter topics.
          </p>
